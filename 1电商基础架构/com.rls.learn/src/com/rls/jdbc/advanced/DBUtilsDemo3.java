...
public class DBUtilsDemo3 {
	...
	public void demo1() throws SQLException {
		...
		Object[] objs = queryRunner.query("select * from user where id = ?", new ArrayHandler(), 2);
	...
	public void demo3() throws SQLException {
		QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
		Account account = queryRunner.query("select * from user where id = ?",
	...
	public void demo4() throws SQLException {
		QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
		List<Account> list = queryRunner.query("select * from user ", new BeanListHandler<Account>(Account.class));
	...
	public void demo5() throws SQLException{
		QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
		Map<String,Object> map = queryRunner.query("select * from user where id = ?", new MapHandler(), 2);
	...
	public void demo7() throws SQLException{
		QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
		List<Object> list = queryRunner.query("select name,money from user", new ColumnListHandler("name"));
	...
	public void demo8() throws SQLException{
		QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
		Object obj = queryRunner.query("select count(*) from user", new ScalarHandler());
	...
	public void demo9() throws SQLException{
		QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
		Map<Object,Map<String,Object>> map = queryRunner.query("select * from user", new KeyedHandler("id"));
